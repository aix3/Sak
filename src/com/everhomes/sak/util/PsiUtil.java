...
public class PsiUtil {
    ...
    public static PsiClass getPsiClass(AnActionEvent anActionEvent) {
        return PsiTreeUtil.getParentOfType(getCurrentElement(anActionEvent), PsiClass.class);
    }
...
//    }
    ...
    public static PsiElement getCurrentElement(AnActionEvent anActionEvent) {
